...
const Port_ConfigType pins_config_structure = {
    PORTA, PIN0, INPUT , OFF    , STD_LOW, GPIO, DIR_CHANGEABLE, MODE_CHANGEABLE,          /* PORTA PIN0: 17*/
    PORTA, PIN1, OUTPUT, OFF    , STD_LOW, GPIO, DIR_CHANGEABLE, MODE_CHANGEABLE,          /* PORTA PIN1: 18*/
    PORTA, PIN2, INPUT , OFF    , STD_LOW, GPIO, DIR_CHANGEABLE, MODE_CHANGEABLE,          /* PORTA PIN2: 19*/
    PORTA, PIN3, INPUT , OFF    , STD_LOW, GPIO, DIR_CHANGEABLE, MODE_CHANGEABLE,          /* PORTA PIN3: 20*/
    PORTA, PIN4, INPUT , PULL_UP, STD_LOW, GPIO, DIR_CHANGEABLE, MODE_CHANGEABLE,          /* PORTA PIN4: 21*/
    PORTA, PIN5, INPUT , OFF    , STD_LOW, GPIO, DIR_CHANGEABLE, MODE_CHANGEABLE,          /* PORTA PIN5: 22*/
                                                                        
    PORTB, PIN0, OUTPUT, OFF, STD_LOW, GPIO, DIR_CHANGEABLE, MODE_CHANGEABLE,          /* PORTB PIN0: 29*/
    PORTB, PIN1, OUTPUT, OFF, STD_LOW, GPIO, DIR_CHANGEABLE, MODE_CHANGEABLE,          /* PORTB PIN1: 30*/
    PORTB, PIN2, OUTPUT, OFF, STD_LOW, GPIO, DIR_CHANGEABLE, MODE_CHANGEABLE,          /* PORTB PIN2: 33*/
    PORTB, PIN3, OUTPUT, OFF, STD_LOW, GPIO, DIR_CHANGEABLE, MODE_CHANGEABLE,          /* PORTB PIN3: 34*/
    ...
    PORTB, PIN6, INPUT , OFF, STD_LOW, GPIO, DIR_CHANGEABLE, MODE_CHANGEABLE,          /* PORTB PIN6: 42*/
