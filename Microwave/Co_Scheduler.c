...
/*******************************************************************************
* modify only these three functions in case of:                                  *
...
STATIC void Timer_Init(void ){
    SysTickInit(OS_BASE_TIME);	/* 20 milli second interrupt.*/
}

STATIC void Timer_Start(void){
    SysTickStart();            /* enable SysTick*/
}

STATIC void Timer_Stop(void){
    SysTickStop();            /* disable SysTick*/
}
...
* Parameters (out): None
* Return value: None
* Description: Function to stop the timer of the sheduler
********************************************************************************/
void SCH_Stop(void){
    Timer_Stop();
}
